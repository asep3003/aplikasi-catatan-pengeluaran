...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('catatans.index') }}">Metode Pembayaran</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('catatans.store') }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <a href="{{route('catatans.index')}}" class="btn btn-sm btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
